...
<head>
    ...
    <script>
        ...
        fbq('init', '858038840319128');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=858038840319128&ev=PageView&noscript=1" /></noscript>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="https://www.instagram.com/kopergrosir.jkt/" target="_blank"
                                class="text-xs text-slate-500 font-semibold hover:text-secondary transition">kopergrosir.jkt</a>
                        </div>
                    </div>
                </div>
            </div>
