        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20 overflow-x-hidden">
                <div data-aos="fade-right">
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-10">
                        <div class="flex items-center gap-3 group">
                            ...
                            <span class="text-sm font-black text-blue-800 uppercase tracking-wider">Pengecatan Presisi</span>
                        </div>
                ...
                <div class="grid grid-cols-2 grid-rows-2 gap-4 h-[550px]" data-aos="fade-left">
                    ...
                    <div class="col-span-1 rounded-[2.5rem] overflow-hidden border border-blue-50 shadow-xl group relative">
    ...
    <section id="katalog" class="py-24 bg-slate-50" x-data="{ activeCategory: 'all' }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12" data-aos="fade-up">
                <span class="text-secondary font-black text-[10px] uppercase tracking-[0.3em] mb-2 block">Our Collections</span>
            ...
            <div class="mb-12 overflow-x-auto no-scrollbar pb-4 flex md:justify-center gap-3" data-aos="fade-up">
                ...
                @foreach ($categories as $cat)
                    <button @click="activeCategory = '{{ $cat->slug }}'"
                        :class="activeCategory === '{{ $cat->slug }}' ? 'bg-secondary text-white shadow-xl shadow-blue-600/20' :
                            'bg-white text-slate-400 border border-blue-100 hover:border-secondary hover:text-secondary'"
                        class="flex-none px-7 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all whitespace-nowrap active:scale-95">
                        {{ $cat->name }}
                    </button>
                ...
                @foreach ($products as $product)
                    <div x-show="activeCategory === 'all' || activeCategory === '{{ $product->category->slug ?? '' }}'"
                        ...
                        <div class="relative aspect-[3/4] bg-slate-100 overflow-hidden">
                            ...
                            <div class="absolute bottom-3 right-3 flex flex-col items-end gap-1.5 pointer-events-none">
                                @if (!$product->is_package && $product->size)
                                    <span class="bg-white/95 backdrop-blur shadow-lg text-primary text-[10px] font-black px-3 py-1 rounded-lg border border-blue-50">
                                        {{ $product->size }}
                                    </span>
                                @endif
                                @if ($product->material)
                                    <span class="bg-white/95 backdrop-blur shadow-lg text-primary text-[10px] font-black px-3 py-1 rounded-lg border border-blue-50 uppercase truncate max-w-[90px]">
                                        {{ $product->material }}
                                    </span>
                                @endif
                            </div>
                        ...
                        <div class="p-5 flex flex-col flex-grow bg-white border-t border-blue-50/50">
                            <h4 class="text-sm md:text-base font-black text-primary leading-tight mb-4 line-clamp-2 h-10 md:h-12 tracking-tight group-hover:text-secondary transition-colors">
                                {{ $product->name }}
                            </h4>
    
                            <div class="mt-auto flex items-end justify-between gap-2">
                                <div class="flex flex-col">
                                    <span class="text-[9px] font-black text-secondary uppercase tracking-[0.2em] leading-none mb-1.5">
                                        Ready Stock
                                    </span>
                                ...
                                <a href="https://wa.me/{{ $waNumber->value ?? '' }}" target="_blank"
                                    ...
                                    <svg class="w-6 h-6 transform group-hover/btn:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
